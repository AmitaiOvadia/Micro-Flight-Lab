function [best_subsample, worse_subsample] = sample_from_data(Data, num_of_samples, iterations, num_of_bins)
...
for i = 1 : iterations
    ...
    error_i = compare_histograms(Data, sub_sample_indexses, num_of_bins);  
    errors(i) = error_i; 
    if mod( i , 100 ) == 0
        disp(i);
    end
